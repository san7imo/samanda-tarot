    ...
    <>
      ...
      <Section ariaLabel="Samanda Tarot y Guía espiritual">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-3xl border border-gold/20 bg-ivory px-6 py-6 text-sm text-olive/80">
      ...
      <Section ariaLabel="Bloques de intención">
        <div className="grid gap-6 lg:grid-cols-3">
          {intentions.map((item) => (
            <div
              key={item.title}
              className="rounded-3xl border border-gold/20 bg-ivory px-6 py-8 shadow-[0_18px_40px_-32px_rgba(43,28,47,0.35)]"
            >
              ...
              <a
                ...
                className="mt-6 inline-flex text-xs uppercase tracking-[0.3em] text-gold hover:text-plum"
              >
                Quiero claridad
              </a>
            </div>
      ...
      <section className="bg-gold/15 px-6 py-6 text-center sm:px-10 lg:px-16">
      ...
      <Section id="servicios" ariaLabel="Servicios principales">
        <div className="space-y-8">
          <div className="flex flex-col gap-3">
            <p className="text-xs uppercase tracking-[0.4em] text-gold">Servicios principales</p>
            <h2 className="text-3xl font-semibold text-plum">
              Lecturas y rituales para guiar tu camino
            </h2>
          </div>
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="rounded-3xl border border-gold/20 bg-ivory px-8 py-8 shadow-[0_18px_40px_-32px_rgba(43,28,47,0.35)]">
              <p className="text-xs uppercase tracking-[0.4em] text-gold">
      ...
      <Section ariaLabel="Rituales energéticos">
        <div className="rounded-3xl border border-gold/20 bg-ivory px-6 py-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.4em] text-gold">Rituales energéticos</p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <CTAButton href={whatsappRitualRequest} size="sm">
                Solicitar mi ritual
              </CTAButton>
            </div>
          </div>
      ...
      <Section ariaLabel="Amuletos destacados">
        <div className="space-y-6">
          <div className="flex flex-col gap-3">
            <p className="text-xs uppercase tracking-[0.4em] text-gold">Amuletos destacados</p>
          ...
          <CTAButton href="/tienda" variant="secondary" size="sm" className="w-fit">
            Ver tienda
          </CTAButton>
        </div>
      </Section>
      ...
      <Section ariaLabel="Testimonios">
        <div className="space-y-6">
          <div className="flex flex-col gap-3">
            <p className="text-xs uppercase tracking-[0.4em] text-gold">Testimonios</p>
            <h2 className="text-3xl font-semibold text-plum">Experiencias reales, acompañamiento cercano</h2>
          </div>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((item) => (
              <div key={item.name} className="rounded-3xl border border-gold/20 bg-ivory px-6 py-6">
                <p className="text-sm text-olive/80">&quot;{item.text}&quot;</p>
                <p className="mt-4 text-xs uppercase tracking-[0.3em] text-gold">{item.name}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <Section ariaLabel="Blog y consejos">
        <div className="space-y-6">
          <div className="flex flex-col gap-3">
            <p className="text-xs uppercase tracking-[0.4em] text-gold">El Blog Oráculo</p>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {blogPosts.map((post) => (
              <article
                key={post.title}
                className="overflow-hidden rounded-3xl border border-gold/20 bg-ivory"
              >
                ...
                <div className="space-y-3 px-6 py-6">
                  ...
                  <Link
                    href={post.href}
                    className="text-xs uppercase tracking-[0.3em] text-gold hover:text-plum"
                  >
                    Leer artículo
                  </Link>
                </div>
      ...
      <Section ariaLabel="Contacto y agendamiento">
        <div className="grid gap-8 rounded-3xl border border-gold/20 bg-ivory px-6 py-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-4">
