    ...
    <>
      <Section className="bg-plum text-ivory" ariaLabel="Samanda hero">
        <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative aspect-[3/4] w-full overflow-hidden rounded-[32px] border border-gold/20">
            <Image
      ...
      <Section ariaLabel="Historia y enfoque">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-4">
            <p className="text-xs uppercase tracking-[0.4em] text-gold">Historia y enfoque</p>
          ...
          <div className="rounded-3xl border border-gold/20 bg-ivory px-6 py-6 shadow-[0_18px_40px_-32px_rgba(43,28,47,0.35)]">
            <p className="text-xs uppercase tracking-[0.3em] text-gold">Valores</p>
      ...
      <Section ariaLabel="Método de trabajo">
        <div className="space-y-6">
          <div className="flex flex-col gap-3">
            <p className="text-xs uppercase tracking-[0.4em] text-gold">Método de trabajo</p>
