    ...
    <>
      <Section className="bg-plum text-ivory" ariaLabel="Contacto hero">
        <div className="space-y-6">
          <p className="text-s uppercase tracking-[0.4em] text-gold">Contacto</p>
      ...
      <Section ariaLabel="Datos de contacto">
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-3xl border border-gold/70 bg-ivory px-6 py-8">
            <p className="text-s uppercase tracking-[0.4em] text-yellow-700">Formulario de contacto</p>
          ...
          <div className="space-y-6">
            <div className="rounded-3xl border border-gold/70 bg-ivory px-6 py-8">
              <p className="text-s uppercase tracking-[0.4em] text-yellow-700">Información directa</p>
              <div className="mt-4 space-y-3 text-sm text-olive/80">
                ...
                <p>
                  Fijo:{" "}
                  <a href="tel:+34915395850" className="text-plum hover:text-yellow-700">
                    +34 91 539 58 50
                  </a>
                </p>
                <p>
                  WhatsApp:{" "}
                  <a href={whatsappLink} className="text-plum hover:text-yellow-700">
                    +34 651 543 179
                  </a>
                </p>
                <p>
            ...
            <div className="rounded-3xl border border-gold/70 bg-ivory px-6 py-8">
              <p className="text-xs uppercase tracking-[0.4em] text-yellow-700">Redes sociales</p>
              <div className="mt-4 grid grid-cols-2 gap-3 text-sm text-olive/80">
                <a
                  href="https://instagram.com"
                  className="flex items-center gap-3 rounded-2xl border border-gold/20 px-4 py-3 text-plum hover:border-gold hover:text-yellow-700"
                >
